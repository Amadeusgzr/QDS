...
?>
    ...
    <form action="ingreso-lote-3.php" id="form-lote" method="post">
        ...
        <div class="div-datos-lote">
            ...
            <select name="select-camion-lote" id="select-camion-lote">
                <option value="Camion" selected disabled>Camión asignado</option>
                <option value="Camion 1">Camión 1</option>
                <option value="Camion 2">Camión 2</option>
                <option value="Camion 3">Camión 3</option>
            </select>
        ...
        <div class="div-datos-lote">
                ...
                <a href="ingreso-lote-3.php"><input type="submit" class="submit-lote boton-siguiente" value="Siguiente"></a>
                <a href="ingreso-lote.php"><input type="button" class="submit-lote boton-volver" class="boton-volver" value="Volver"></a>
        </div>
