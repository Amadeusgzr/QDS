...
function enviarDatos() {
    ...
    var tabla = document.getElementById("tabla-admin-camioneros");
        ...
        if(fila.classList.contains("fila-seleccionada")){
            ...
            id_empresas_clientes.push(contenido);
        }
        

    }
    var jsonString = JSON.stringify(id_empresas_clientes);

    // Crear un objeto FormData para enviar datos al servidor
    var formData = new FormData();
    formData.append('id_empresas_clientes', jsonString);
    ...
    xhr.onload = function () {
        if (xhr.status === 200) {
            ...
            location.href = "op-empresas-cliente.php?datos=" + respuesta;
