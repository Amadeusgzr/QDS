...
function enviarDatos() {
    ...
    var tabla = document.getElementById("tabla-admin-camioneros");
        ...
        if(fila.classList.contains("fila-seleccionada")){
            ...
            id_camionetas.push(contenido);
        }
        

    }
    var jsonString = JSON.stringify(id_camionetas);

    // Crear un objeto FormData para enviar datos al servidor
    var formData = new FormData();
    formData.append('id_camionetas', jsonString);
    ...
    xhr.onload = function () {
        if (xhr.status === 200) {
            ...
            location.href = "op-camionetas.php?datos=" + respuesta;
