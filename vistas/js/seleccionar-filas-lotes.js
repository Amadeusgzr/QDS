...
function enviarDatos() {
    ...
    var tabla = document.getElementById("tabla-lote");
        ...
        if(fila.classList.contains("fila-seleccionada")){
            ...
            id_plataformas.push(contenido);
        }
        

    }
    var jsonString = JSON.stringify(id_plataformas);

    // Crear un objeto FormData para enviar datos al servidor
    var formData = new FormData();
    formData.append('id_plataformas', jsonString);
    ...
    xhr.onload = function () {
        if (xhr.status === 200) {
            ...
            location.href = "op-plataforma.php?datos=" + respuesta;
