...
function enviarDatos() {
    ...
    var tabla = document.getElementById("tabla-admin-camioneros");
        ...
        if(fila.classList.contains("fila-seleccionada")){
            ...
            id_almacenes_centrales.push(contenido);
        }
        

    }
    var jsonString = JSON.stringify(id_almacenes_centrales);

    // Crear un objeto FormData para enviar datos al servidor
    var formData = new FormData();
    formData.append('id_almacenes_centrales', jsonString);
    ...
    xhr.onload = function () {
        if (xhr.status === 200) {
            ...
            location.href = "op-almacen-central.php?datos=" + respuesta;
