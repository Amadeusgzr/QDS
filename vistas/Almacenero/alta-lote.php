...
?>
    ...
    <form action="../../controladores/api/lote/agregarDato.php" id="form-lote-2" method="post">
        ...
        <div class="div-datos-lote">
            ...
            <input type="date" name="fecha_traslado_lote" id="fecha-traslado-lote" class="tiempo-lote" placeholder="Nombre destinatario" autocomplete="off">
            <p class="p-lote">Hora traslado</p>
            <input type="time" name="hora_traslado_lote" id="hora-traslado-lote" class="tiempo-lote" placeholder="Nombre destinatario" autocomplete="off">
