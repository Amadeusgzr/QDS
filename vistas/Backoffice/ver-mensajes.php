...
<div id="div-notificaciones">
    <div class="navbar">
        <button class="seccion-btn active" id="Sin responder">Sin responder</button>
        <button class="seccion-btn" id="En curso">En curso</button>
        <button class="seccion-btn" id="Resuelto">Resuelto</button>
    </div>
    <div id="contenido">
    </div>
</div>
