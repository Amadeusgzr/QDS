    ...
    <div class="contenedor-tabla">
        <table id="tabla-admin-camioneros">
            ...
            foreach ($almacenes_central as $almacen_central) {
                ...
                echo "<td>
                <a href='alta-logica.php?id_almacen_central=$id_almacen_central'><button class='btn-op btn-op2'><img src='../img/iconos/modificar.png' width='20px'></button></a>
                <a href='consultar-dato.php?id_almacen_central1=$id_almacen_central'><button class='btn-op btn-op3'><img src='../img/iconos/consultar.png' width='20px'></button></a>
                </td>";
                echo "</tr>";
            }
            ?>
