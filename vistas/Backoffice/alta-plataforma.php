...
<div class="form-crud">
  <form action="alta-plataforma.php" method="post">
    ...
    <input type="text" placeholder="Departamento" class="txt-crud" name="departamento[]" required maxlenght="11">
...
<script
  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD3apFCRO-Fq2fccUb-g6GvinOzsh-vDYM&libraries=places"></script>
<script>
