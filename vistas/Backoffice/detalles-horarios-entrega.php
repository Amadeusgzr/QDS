...
<a href='consultar-dato.php?id_camion_horario=<?=$id_camion?>&fs=<?=$fecha_salida?>&acs=<?=$almacen_central_salida?>'><input type='submit' value='Volver' class='estilo-boton boton-volver'></a>
</div>
